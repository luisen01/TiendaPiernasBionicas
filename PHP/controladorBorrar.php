<html>
  <head>
    <title>Proceso de borrado de producto</title>
  </head>
  <body>
...
$productoBorrar = new Producto($codigo,$descripcion,$rebaja,$estarebajado,$precio);



//Vamos a por la
$SQLDelete = $productoBorrar->getDeleteSQL();
